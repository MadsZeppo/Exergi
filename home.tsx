            ...
            <div className="ex-shell">
              <div className="ex-chrome">
                <div className="ex-chrome-left">
                  ...
                  <div className="ex-chrome-title">
                    Exergi · Decision Feed
                  </div>
                </div>
                ...
                <section className="ex-main">
                  <div className="ex-main-top">
                    <div>
                      ...
                      <h2 className="ex-main-title">
                        Three decisions ready
                      </h2>
                    ...
                    <div className="ex-tabs">
                      <span className="ex-tab active">
                        Ready
                      </span>

                      <span className="ex-tab">
                        In test
                      </span>
                    ...
                    <article className="ex-row featured">
                      <div>
                        <div className="ex-row-kicker">
                          Shipping
                          <span className="ex-badge test">
                            TEST
                          </span>
                        </div>

                        <h3>
                          Raise free-shipping threshold to $65
                        </h3>
                      ...
                      <div className="ex-confidence">
                        <div className="ex-confidence-top">
                          <span className="ex-confidence-num">
                            87%
                          </span>

                          <span className="ex-confidence-small">
                            beats BAU
                          </span>
                        </div>
                    ...
                    <article className="ex-row">
                      <div>
                        <div className="ex-row-kicker">
                          ...
                          <span className="ex-badge bau">
                            BAU
                          </span>
                        </div>

                        <h3>
                          Keep Core Bundle at $89
                        </h3>
                    ...
                    <article className="ex-row">
                      <div>
                        <div className="ex-row-kicker">
                          ...
                          <span className="ex-badge avoid">
                            AVOID
                          </span>
                        </div>

                        <h3>
                          Avoid 20% win-back discount
                        </h3>
          ...
          <div className="ex-wrap">
            ...
            <div className="ex-figures">
              ...
              <article className="ex-figure">
                ...
                <h3>
                  Understand the economics before acting
                </h3>
        ...
        <section className="ex-section" id="how">
          <div className="ex-wrap">
            <div className="ex-section-head">
              <div className="ex-section-num">
                01 · How Exergi works
              </div>

              <h2>
                From raw commerce data to a decision you can defend.
              </h2>
            </div>

            <div className="ex-flow">
              <div className="ex-step">
                <div className="ex-step-index">
                  01
                </div>
          ...
          <div className="ex-wrap">
            <div className="ex-final-box">
              <div>
                ...
                <h2>
                  Help shape the decision layer for commerce.
                </h2>
